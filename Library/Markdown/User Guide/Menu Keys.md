...
GCS comes with several shortcuts pre-set for common actions (like copy, paste, or scaling the sheet). You can **add new
shortcuts** or **change existing ones** to match your preferences.
...
- **Import or export settings:** On the **Menu Keys toolbar**, select **Menu** ![menu](images/icons/icn-menu.svg), then
  choose:
...
You can remove a shortcut by clearing the field or reset it by selecting **Reset** ![reset](images/icons/icn-reset.svg).

> [!WARNING] Some shortcuts may **conflict with system-level hotkeys** (for example, `Cmd+Space` on macOS opens
> Spotlight). If a shortcut doesn’t seem to work in GCS, try assigning a different combination that isn’t already
> reserved by your operating system.

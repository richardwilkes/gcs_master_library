...
When you create a new character sheet, GCS applies a default number of starting points. You can change the default in [General Settings](General%20Settings).
